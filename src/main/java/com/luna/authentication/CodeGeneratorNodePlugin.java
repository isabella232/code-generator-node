...
/**
 * Plugin to install node.
 */
public class CodeGeneratorNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public CodeGeneratorNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
